...
import type { TestingProgram } from "../target/types/testing_program";

const IDL = require("../target/idl/testing_program.json");
...
describe("Bankrun example", async () => {
  const context = await startAnchor(
    "",
    [
      { name: "testing", programId: PROGRAM_ID },
  ...
  const program = new anchor.Program<TestingProgram>(IDL, provider);
